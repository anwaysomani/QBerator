...
# Views for Django-Bootstrap-Modal-Form
...
class CreateView(CreateView):
    ...
    form_class = TestForm
    success_url = reverse_lazy('modal:success_view')

class UpdateView(UpdateView):
    model = Test
    template_name = 'modal/modal.html'
    form_class = TestForm
    succeess_url = reverse_lazy('modal:success_view')

class SuccessView(TemplateView):
    template_name = "modal/success.html"
...
class NewsCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        return render(self.request, 'modal/success.html', {'news': self.object})
