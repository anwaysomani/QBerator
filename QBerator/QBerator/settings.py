"""
Django settings for questionb project.
...
SECRET_KEY = 'j85b0a_nwn=^#-9m$yz$5=o1h($epyjg(xuh-9ov%#og4ll@80'
...
INSTALLED_APPS = [
    ...
    #External ckeditor for queestions
    'ckeditor', #pypi
    'ckeditor_uploader', #pypi
]
...
WSGI_APPLICATION = 'QBerator.wsgi.application'
